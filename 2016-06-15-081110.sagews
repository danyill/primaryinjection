...
︡a5f6ca86-3223-4d8d-bff7-30bc84301823︡{"done":true}︡
...
def processSVG(listofchanges, filename = 'sketch_primary_current_injection.svg', outname = 'sketch_primary_current_injection_filled_in.svg'):
    ...
    tree.write(outname)
︡7d4a7a61-287d-4e5d-8738-6ba733bc2539︡{"done":true}︡
...
︡1f5ee88d-c2da-4dbe-b70e-039a73ed518f︡{"done":true}︡
...
def _(hv_checkbox = checkbox(True, label='Inject on HV'),
    ...
    picture_elements.append(['ohms-at-voltage', eng_string(Z_transformer.n(),"%.2f") + ' ohms at ' + eng_string((V_base*1000).n(),"%.0f", si=True) + "V" ])
